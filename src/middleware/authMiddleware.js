...
const authMiddleware = (req, res, next) => {
    try {
        ...
        // تأمين إضافي: التأكد من أن الهيدر يبدأ بكلمة Bearer فعلياً
        ...
        // jwt.verify هيقوم بالمهمة دي ولو التوكن فيه مشكلة هيرمي Error يدخلنا في الـ catch
        ...
        // 5. تخزين البيانات في كائن req.user لاستخدامها في الـ Controllers
        req.user = {
            id: userId,
            role: userRole,
        ...
        // أي خطأ آخر (توكن مزور، مفتاح سري خطأ، إلخ)
        return res.status(403).json({ 
            success: false, 
