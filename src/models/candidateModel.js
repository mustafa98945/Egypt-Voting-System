...
class Candidate {
    // 1. الـ Triple Check - بيرجع بيانات المواطن كاملة من السجل (بما فيها صور البطاقة الموثقة)
    ...
    // 2. إنشاء مرشح (بيشمل الحقول الـ 27 كاملة)
    static async create(data) {
        const query = `
            INSERT INTO candidates (
                ...
                national_id_front_url, national_id_back_url, -- دول بيتسحبوا من السجل المدني
        ...
        const values = [
            // أ) البيانات المسحوبة أوتوماتيكياً من السجل المدني (citizen)
            data.username, 
            ...
            data.national_id_front_url, // مسحوب من السجل
            data.national_id_back_url,  // مسحوب من السجل
            
            // ب) البيانات المدخلة من المرشح (نصوص)
            data.email, 
            data.password, 
            data.national_id, 
            data.birth_date, 
            ...
            // ج) الـ 5 ملفات الانتخابية المرفوعة حديثاً
